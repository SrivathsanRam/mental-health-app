...
function SOSButton() {
  ...
  return (
    <Pressable style={styles.sosHoning1} onPress={() => handleSOSPress(sosHelpline)}>
...
<Text style={styles.text}>The button will bing up your phone's dialer but will not call imediately.</Text>
